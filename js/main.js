...
(function($, moment, ClipboardJS, config) {
    ...
    //     $('span.title.function_').each(function() {
    //         var content = $(this).text();
    //         functionNameList.push(content);
    //     });
    //     // 渲染所有函数名
    //     var selector = 'span.title.function_';
    //     $('.code.line').each(function() {
    //         var $codeElement = $(this);
    //         var html = $codeElement.html();

    //         functionNameList.forEach(function(content) {
    //         var wrappedContent = '<span class="' + selector + '">' + content + '</span>';
    //         html = html.replace(content, wrappedContent);
    //         });

    //         $codeElement.html(html);
    //     });
    // }
